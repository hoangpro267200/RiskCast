            ...
            <div class="{card_class}">
                ...
                <div class="top3-sub info-tt">
                    ...
                    <span class="info-text">
                        ...
                        • <b>ICC A</b>: Bảo hiểm rộng nhất.<br>
                        • <b>ICC B</b>: Mức trung bình.<br>
                        • <b>ICC C</b>: Cơ bản, giá thấp.<br><br>
                        Gói càng cao → bảo vệ càng rộng.
                    </span>
                </div>
                ...
                <div class="top3-sub info-tt" style="color:#7CFFA1; font-size:1.1rem;">
                    ...
                    <span class="info-text">
                        <b>Ý nghĩa</b><br><br>
                        Chi phí ước tính từ mô phỏng Monte Carlo.<br>
                        So sánh mức tiết kiệm – mức độ bảo vệ.
                    </span>
                </div>
                ...
                <div class="top3-sub info-tt">
                    ...
                    <span class="info-text">
                        Điểm tổng hợp TOPSIS dựa trên 6 tiêu chí rủi ro và dịch vụ.
                    </span>
                </div>
                ...
                <div class="top3-sub info-tt">
                    ...
                    <span class="info-text">
                        Chỉ số ổn định sau mô phỏng Monte Carlo.
                    </span>
                </div>
                ...
                <div class="top3-sub info-tt">
                    ...
                    <span class="info-text">
                        Mức dao động rủi ro khí hậu tuyến đường.
                    </span>
                </div>

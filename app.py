    ...
    def display_results(self, result: AnalysisResult, params: AnalysisParams):
        ...
        st.markdown(
            ...
            <div class="explanation-box">
                ...
                <ul>
                    <li><b>{top['company']} - {top['icc_package']}</b> có điểm cao nhất vì cân bằng tốt giữa chi phí và bảo vệ</li>
                    <li>Chi phí <b>${top['estimated_cost']:,.0f}</b> phù hợp với mục tiêu <b>{params.priority}</b></li>
                    <li>Độ tin cậy <b>{top['confidence']:.2f}</b> cho thấy kết quả ổn định</li>
                    <li>Hệ thống đã phân tích <b>15 phương án</b> từ 5 công ty và 3 gói ICC</li>
                </ul>
            </div>
            """,
            unsafe_allow_html=True

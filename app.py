...
class StreamlitUI:
    ...
    def display_results(self, result: AnalysisResult, params: AnalysisParams):
        ...
        # ===== HÀNG 1: Cost–Benefit & Category comparison (tách rõ + có khung) =====
        ...
        # Top 5 – full width, cũng bọc card cho có khung
        st.markdown('<div class="rc-card">', unsafe_allow_html=True)
        ...
        # ===== HÀNG 2: Weights pie & Forecast (tách rõ + có khung) =====
        st.markdown("---")
